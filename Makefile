...
ft_isspace.c ft_isupper.c ft_islower.c ft_memrchr.c ft_isblank.c ft_lstrev.c
LIB_OBJS 	= $(LIB:.c=.o)
SRCS_OBJS	= $(SRCS:.c=.o)
...
$(NAME):
	@gcc -Wall -Werror -Wextra -c $(SRCS) $(addprefix libft/, $(LIB)) -I . -I libft/
	@gcc -o $(NAME) $(SRCS_OBJS) $(LIB_OBJS)

clean:
	@rm -rf $(SRCS_OBJS) $(LIB_OBJS)
